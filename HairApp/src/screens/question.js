...
export default function QuestionScreen(props) {
    ...
    loadQuestion = (qNumber) => {
        console.log(qNumber);
        if (qNumber == 9 && userProfile.length > 0 && (userProfile[1].answer == '1'))
        {
            submitUserProfile()
            return;
        }
        if (qNumber == 8 && userProfile.length > 0 && (userProfile[1].answer == '2'))
        {
            submitUserProfile()
            return;
        }
    ...
    renderQuestionIndex = () => {
        if (userProfile.length > 0 && (userProfile[1].answer == '1'))
        {
            return (
                <Text style={[styles.primaryText,{fontSize:20,marginTop:10,textAlign:'center'}]}>{question} of 8</Text>
            )
        }
        else if (userProfile.length > 0 && (userProfile[1].answer == '2'))
        {
            return (
                <Text style={[styles.primaryText,{fontSize:20,marginTop:10}]}>{question} of 7</Text>
            )
        }
    }
