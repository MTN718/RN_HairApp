...
export default function TutorialScreen(props) {
    ...
    renderTruncatedFooter = (handlePress) => {
        return (
          <Text style={{color: '#f00', marginTop: 5}} onPress={handlePress}>
            Read more
          </Text>
        );
      }
        ...
        <View style={{flex:1,marginTop:50,paddingLeft:16,paddingRight:16}}>
            <View style={{flexDirection:'row'}}>
                <Image style={{width:50,height:40}}
                    ...
                    resizeMode="stretch"
                />
                <Text style={[styles.primaryText,{flex:1,marginTop:10,marginLeft:10,fontSize:20,fontWeight:'600'}]}>Hair</Text>
            ...
            <View style={{flex:1}}>
                {
                    ...
                    <View style={{justifyContent:'center',flex:1}}>
                        <ScrollView>
                            ...
                            {
                                steps.length > 0 && steps[stepIndex - 1].picture ? 
